...
// RegisterRoutes wires all impact_pd HTTP routes under the given /api/v1 group.
//
// Route layout:
//
//	GET    /master/impact-pd                  → List           (ecl_parameter.read)
//	POST   /master/impact-pd                  → Create         (ecl_parameter.submit)
//	GET    /master/impact-pd/export           → Export         (ecl_parameter.read)
//	GET    /master/impact-pd/:id              → GetByID        (ecl_parameter.read)
//	PUT    /master/impact-pd/:id              → Update         (ecl_parameter.submit)
//	DELETE /master/impact-pd/:id              → Delete         (ecl_parameter.submit)
...
//	POST   /master/impact-pd/:id/approve      → Approve        (ecl_parameter.approve)
//	POST   /master/impact-pd/:id/approve2     → Approve2       (ecl_parameter.approve)
